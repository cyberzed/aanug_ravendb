...
{
	var overview = documentSession.Query<SpeakerSessionOverview,SpeakerSessionOverviewIndex>()
					.TransformWith<SpeakerSessionOverview2Transformer,SpeakerSessionOverview2>();
